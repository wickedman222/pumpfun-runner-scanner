...
GATHER_MODE = _int("GATHER_MODE", 0) == 1
...
PAPER_BOOK_ID = _env("PAPER_BOOK_ID", "kamino-1")
...
DEX_MODE = _int("DEX_MODE", 0) == 1
STRICT_MODE = _int("STRICT_MODE", 0) == 1
KAMINO_MODE = _int("KAMINO_MODE", 1) == 1
KAMINO_POLL_SEC = _int("KAMINO_POLL_SEC", 20)
KAMINO_CONFIRM_SEC = _int("KAMINO_CONFIRM_SEC", 25)
KAMINO_MIN_BONUS_BPS = _int("KAMINO_MIN_BONUS_BPS", 50)
KAMINO_MIN_DEBT_USD = _float("KAMINO_MIN_DEBT_USD", 40.0)
KAMINO_CASH_FLOOR = _float("KAMINO_CASH_FLOOR", 0.40)
KAMINO_PRIO_SOL = _float("KAMINO_PRIO_SOL", 0.0002)
KAMINO_INCLUDE_MAIN = _int("KAMINO_INCLUDE_MAIN", 0) == 1
KAMINO_GPA_TIMEOUT = _float("KAMINO_GPA_TIMEOUT", 75.0)
KAMINO_VERIFY_N = _int("KAMINO_VERIFY_N", 24)
STRICT_POLL_SEC = _int("STRICT_POLL_SEC", 2)
STRICT_CATCH_SEC = _int("STRICT_CATCH_SEC", 8)
STRICT_VOL_SEC = _int("STRICT_VOL_SEC", 30)
STRICT_BUNDLE_PCT = _float("STRICT_BUNDLE_PCT", 3.0)
STRICT_TOP5_PCT = _float("STRICT_TOP5_PCT", 12.0)
STRICT_MIN_VOL_USD = _float("STRICT_MIN_VOL_USD", 5_000)
STRICT_PRIO_SOL = _float("STRICT_PRIO_SOL", 0.00015)
STRICT_STOP_MULT = _float("STRICT_STOP_MULT", 0.70)
STRICT_TRAIL_ARM = _float("STRICT_TRAIL_ARM", 1.40)
STRICT_TRAIL_GIVE = _float("STRICT_TRAIL_GIVE", 0.20)
STRICT_TIME_SEC = _int("STRICT_TIME_SEC", 8 * 60)
STRICT_TIME_MULT = _float("STRICT_TIME_MULT", 1.50)
SOL_USD = _float("SOL_USD", 150.0)
