...
WALLET_REPORT_SEC = _int("WALLET_REPORT_SEC", 6 * 3600)
...
PAPER_FULL_SIZE_MC = _float("PAPER_FULL_SIZE_MC", 55_000)
...
PAPER_SIZE_FRAC = _float("PAPER_SIZE_FRAC", 0.06)  # 2 SOL → 0.12
PAPER_SIZE_MIN = _float("PAPER_SIZE_MIN", 0.10)
PAPER_SIZE_MAX = _float("PAPER_SIZE_MAX", 0.15)
